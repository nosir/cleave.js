    ...
    describe('getFormattedValue:', function () {
        _.each(json.getFormattedValue, function (data) {
            ...
            it('should get formatted value for: ' + params[0] + ' as: ' + data.expected, function () {
                Util.getFormattedValue(params[0], params[1], params[2], params[3], params[4], params[5], params[6]).should.eql(data.expected);
            });
        });
    });
    
    describe('getFormattedValue using dynamicBlocks:', function () {
        _.each(json.getFormattedValueForDynamicBlocks, function (data) {
            var params = data.params;
            it('should get formatted value for: ' + params[0] + ' as: ' + data.expected, function () {
                Util.getFormattedValue(params[0], params[1], params[2], params[3], params[4], params[5], params[6], params[7], params[8]).should.eql(data.expected);
            });
        });
    });
